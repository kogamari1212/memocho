  ...
  ***************************************************************************** */
  ...
  function oe(t, e) {
    if (t) {
      ...
      for (var _r7 = 0; _r7 < _o10.length; _r7++) {
        ...
        for (; _a2;) {
          if (_a2._provided && g(_a2._provided, _i3)) {
            _n18[_s3] = _a2._provided[_i3];
            break;
          }
  ...
  function xe(e, n, r, s, i) {
    ...
    this.data = e, this.props = n, this.children = r, this.parent = s, this.listeners = e.on || t, this.injections = oe(a.inject, s), this.slots = function () {
      return _this2.$slots || ie(e.scopedSlots, _this2.$slots = re(r, s)), _this2.$slots;
    ...
    if (e(r.cid) && void 0 === (r = function (t, r) {
      ...
      if (i && !n(t.owners)) {
        ...
        var _f2 = function _f2(t) {
          ...
          t && (_o18.length = 0, null !== _c2 && (clearTimeout(_c2), _c2 = null), null !== _u && (clearTimeout(_u), _u = null));
        },
            _d2 = D(function (e) {
          t.resolved = Ie(e, r), _a3 ? _o18.length = 0 : _f2(!0);
        }),
            _p = D(function (e) {
          n(t.errorComp) && (t.error = !0, _f2(!0));
        }),
            _h = t(_d2, _p);

        return s(_h) && (l(_h) ? e(t.resolved) && _h.then(_d2, _p) : l(_h.component) && (_h.component.then(_d2, _p), n(_h.error) && (t.errorComp = Ie(_h.error, r)), n(_h.loading) && (t.loadingComp = Ie(_h.loading, r), 0 === _h.delay ? t.loading = !0 : _c2 = setTimeout(function () {
          _c2 = null, e(t.resolved) && e(t.error) && (t.loading = !0, _f2(!1));
        }, _h.delay || 200)), n(_h.timeout) && (_u = setTimeout(function () {
          _u = null, e(t.resolved) && _p(null);
        }, _h.timeout)))), _a3 = !1, t.loading ? t.loadingComp : t.resolved;
      }
  ...
  function De(t, i, a, c, l, u) {
    return (Array.isArray(a) || r(a)) && (l = c, c = a, a = void 0), o(u) && (l = je), function (t, r, i, a, c) {
      ...
      return Array.isArray(l) ? l : n(l) ? (n(u) && function t(r, s, i) {
        ...
        if (n(r.children)) for (var _a4 = 0, _c3 = r.children.length; _a4 < _c3; _a4++) {
          var _c4 = r.children[_a4];
          n(_c4.tag) && (e(_c4.ns) || o(i) && "svg" !== _c4.tag) && t(_c4, s, i);
        }
      }(l, u), n(i) && function (t) {
    ...
    KeepAlive: {
      ...
      render: function render() {
        ...
        if (n) {
          ...
          var _s11 = this.cache,
              _i9 = this.keys,
              _a5 = null == e.key ? n.Ctor.cid + (n.tag ? "::".concat(n.tag) : "") : e.key;

          _s11[_a5] ? (e.componentInstance = _s11[_a5].componentInstance, m(_i9, _a5), _i9.push(_a5)) : (_s11[_a5] = e, _i9.push(_a5), this.max && _i9.length > parseInt(this.max) && bn(_s11, _i9[0], _i9, this._vnode)), e.data.keepAlive = !0;
        }
  ...
  var Pr = function (t) {
    ...
    function f(t, e, r, s, i, c, u) {
      if (n(t.elm) && n(c) && (t = c[u] = mt(t)), t.isRootInsert = !i, function (t, e, r, s) {
        ...
        if (n(i)) {
          var _c5 = n(t.componentInstance) && i.keepAlive;

          if (n(i = i.hook) && n(i = i.init) && i(t, !1), n(t.componentInstance)) return p(t, e), h(r, t.elm, s), o(_c5) && function (t, e, o, r) {
            var s,
                i = t;
    ...
    return function (t, r, s, i) {
      ...
      if (e(t)) c = !0, f(r, u);else {
        ...
        if (!_e35 && Yn(t, r)) x(t, r, u, null, null, i);else {
          ...
          var _i10 = t.elm,
              _c6 = l.parentNode(_i10);

          if (f(r, u, _i10._leaveCb ? null : _c6, l.nextSibling(_i10)), n(r.parent)) {
            var _t42 = r.parent;
    ...
    render: function render(t) {
      ...
      if (s.data.directives && s.data.directives.some(ts) && (s.data.show = !0), l && l.data && !function (t, e) {
        ...
        if ("out-in" === n) return this._leaving = !0, Qt(_e41, "afterLeave", function () {
          _this4._leaving = !1, _this4.$forceUpdate();
        }), Yr(t, o);
    ...
    TransitionGroup: {
      ...
      beforeMount: function beforeMount() {
        ...
        this._update = function (e, n) {
          var o = Ve(_this5);
          _this5.__patch__(_this5._vnode, _this5.kept, !1, !0), _this5._vnode = _this5.kept, o(), t.call(_this5, e, n);
        };
      },
      render: function render(t) {
      ...
      for (n = 0, o = e.length; n < o; n++) {
        if (r = s = e[n].name, i = e[n].value, Is.test(r)) {
          if (t.hasBindings = !0, (a = li(r.replace(Is, ""))) && (r = r.replace(zs, "")), Us.test(r)) r = r.replace(Us, ""), i = mo(i), (l = Hs.test(r)) && (r = r.slice(1, -1)), a && (a.prop && !l && "innerHtml" === (r = _(r)) && (r = "innerHTML"), a.camel && !l && (r = _(r)), a.sync && (c = Eo(i, "$event"), l ? xo(t, "\"update:\"+(".concat(r, ")"), c, null, !1, 0, e[n], !0) : (xo(t, "update:".concat(_(r)), c, null, !1, 0, e[n]), C(r) !== _(r) && xo(t, "update:".concat(C(r)), c, null, !1, 0, e[n])))), a && a.prop || !t.component && ei(t.tag, t.attrsMap.type, r) ? $o(t, r, i, e[n], l) : _o(t, r, i, e[n], l);else if (Ms.test(r)) r = r.replace(Ms, ""), (l = Hs.test(r)) && (r = r.slice(1, -1)), xo(t, r, i, a, !1, 0, e[n], l);else {
            ...
            l = !1, _c7 && (r = r.slice(0, -(_c7.length + 1)), Hs.test(_c7) && (_c7 = _c7.slice(1, -1), l = !0)), wo(t, r, s, i, _c7, l, a, e[n]);
          }
    ...
    preTransformNode: function preTransformNode(t, e) {
      if ("input" === t.tag) {
        ...
        if ((_n63[":type"] || _n63["v-bind:type"]) && (_o53 = ko(t, "type")), _n63.type || _o53 || !_n63["v-bind"] || (_o53 = "(".concat(_n63["v-bind"], ").type")), _o53) {
          ...
          ii(_a6), bo(_a6, "type", "checkbox"), si(_a6, e), _a6.processed = !0, _a6.if = "(".concat(_o53, ")==='checkbox'") + _r32, ai(_a6, {
            exp: _a6.if,
            block: _a6
          });
          ...
          Ao(_c8, "v-for", !0), bo(_c8, "type", "radio"), si(_c8, e), ai(_a6, {
          ...
          return Ao(_l, "v-for", !0), bo(_l, ":type", _o53), si(_l, e), ai(_a6, {
            exp: _n64,
            block: _l
          }), _s18 ? _a6.else = !0 : _i11 && (_a6.elseif = _i11), _a6;
        }
      }
    }
  }];
  ...
  var decodeComponent = function decodeComponent(encodedURI) {
  ...
  function parserForArrayFormat(options) {
    ...
    switch (options.arrayFormat) {
      ...
      case 'separator':
        return function (key, value, accumulator) {
          var isArray = typeof value === 'string' && value.indexOf(options.arrayFormatSeparator) >= 0;
          var isEncodedArray = typeof value === 'string' && !isArray && decode(value, options).indexOf(options.arrayFormatSeparator) >= 0;
  ...
  function parse(query, options) {
    ...
    for (var _i = 0, _a = query.split('&'); _i < _a.length; _i++) {
      ...
      var _b = splitOnFirst(options.decode ? param.replace(/\+/g, ' ') : param, '='),
          key = _b[0],
          value = _b[1]; // Missing `=` should be `null`:
      // http://w3.org/TR/2012/WD-url-20120524/#collect-url-parameters


      value = value === undefined ? null : ['comma', 'separator'].indexOf(options.arrayFormat) >= 0 ? value : decode(value, options);
  ...
  function init_category(query_string) {
    var category = query_string.CAT;
  ...
  function init_hashtag(query_string) {
    var hashtag = query_string.HASH || [];

    if (typeof hashtag == 'string') {
      hashtag = hashtag ? [hashtag] : [];
    }

    return hashtag.slice();
  }

  function init_page(query_string) {
    return query_string.PAGE ? ~~query_string.PAGE : 1;
  }

  function build_query(category, hashtag, page) {
    var queries = [category ? 'CAT=' + category : null, hashtag.length ? 'HASH=' + hashtag.slice().sort().join(',') : null, page > 1 ? 'PAGE=' + page : null].filter(function (row) {
      return !!row;
    });
    return queries.length ? "?" + queries.join('&') : '.';
  }

  var createList = function createList(template) {
    return yn.extend({
      name: 'List',
      props: {
        options: {
      ...
      data: function data() {
        var query_string = parse(location.search, {
          arrayFormat: 'comma'
        });

        var _a = this.options,
            _$template = _a.$template,
            _$items = _a.$items,
            _$update_query = _a.$update_query,
            _$items_per_page = _a.$count,
            $$ = __rest(_a, ["$template", "$items", "$update_query", "$count"]);

        return _assign(_assign({}, $$), {
          _items: this.options.$items ? this.options.$items.slice() : [],
          category: init_category(query_string),
          hashtag: init_hashtag(query_string),
          page: init_page(query_string),
          items_per_page: this.options.$count || -1
        });
      },
      computed: {
        query: function query() {
          return build_query(this.category, this.hashtag, this.page);
        },
        filterd_items: function filterd_items() {
          var _this = this;

          return this.$data._items.map(function (item) {
            return _assign(_assign({}, item), {
              $category_slugs: item.$category_slugs || [],
              $hashtag_slugs: item.$hashtag_slugs || []
            });
          }).filter(function (item) {
            return !_this.category || item.$category_slugs.indexOf(_this.category) >= 0;
          }).filter(function (item) {
            if (!_this.hashtag.length) {
              return true;
            }

            for (var _i = 0, _a = _this.hashtag; _i < _a.length; _i++) {
              var hashtag = _a[_i];

              if (item.$hashtag_slugs.indexOf(hashtag) >= 0) {
                return true;
              }
            }
        ...
        sliced_items: function sliced_items() {
          return this.items_per_page > 0 ? this.filterd_items.slice(this.items_per_page * (this.page - 1)).slice(0, this.items_per_page) : this.filterd_items;
        },
        items: function items() {
          return this.sliced_items;
        },
        num_pages: function num_pages() {
          return Math.ceil(this.filterd_items.length / this.items_per_page);
        },
        num_items: function num_items() {
          return this.filterd_items.length;
        },
        first_query: function first_query() {
          return build_query(this.category, this.hashtag, 1);
        },
        last_query: function last_query() {
          return build_query(this.category, this.hashtag, this.num_pages);
        },
        pagination: function pagination() {
          var _this = this;

          var min = Math.max(this.page - 4, 1);
          var max = Math.min(this.page + 4, this.num_pages);
          return Array.from(new Array(max - min + 1), function (_, i) {
            return {
              page: min + i,
              query: build_query(_this.category, _this.hashtag, min + i)
            };
          });
        },
        ...
        prev_count: function prev_count() {
          return this.items_per_page;
        },
        prev_query: function prev_query() {
          return build_query(this.category, this.hashtag, this.page - 1);
        },
        has_next: function has_next() {
          return this.page < this.num_pages;
        },
        next_count: function next_count() {
          return Math.min(this.items_per_page, this.num_items - this.page * this.items_per_page);
        },
        next_query: function next_query() {
          return build_query(this.category, this.hashtag, this.page + 1);
        }
      },
      watch: {
        query: function query() {
          if (this.options.$update_query) {
  ...
  function qms3_list(options) {
    var defaults = {
      $template: '#qms3_list_template',
      $items: [],
      $update_query: true,
      $count: -1
    };
    options = $__default['default'].extend(defaults, options || {});
    var template_inner = $__default['default'](options.$template).text();
    var template_wrapper = this.clone().empty();
    var template = template_wrapper.append(template_inner).prop('outerHTML');
    var App = {
      components: {
        List: createList(template)
      },
      template: '<List :options="options" />',
      data: function data() {
        return {
